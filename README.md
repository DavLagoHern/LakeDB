...
<p align="center">
  <a href="https://github.com/DavLagoHern/LakeDB/releases/tag/v1.0.0-beta.6.1"><img alt="Download LakeDB Beta 6.1" src="https://img.shields.io/badge/DOWNLOAD-BETA_6.1-0b7cff?style=for-the-badge&logo=github&logoColor=white"></a>
...
<p align="center">
  <a href="https://github.com/DavLagoHern/LakeDB/releases/download/v1.0.0-beta.6.1/LakeDB-1.0.0-beta.6.1-mac-arm64.dmg"><img alt="Download LakeDB for macOS Apple Silicon" src="https://img.shields.io/badge/macOS-DOWNLOAD_DMG-06132b?style=for-the-badge&logo=apple&logoColor=white"></a>
  <a href="https://github.com/DavLagoHern/LakeDB/releases/download/v1.0.0-beta.6.1/LakeDB-1.0.0-beta.6.1-win-x64-setup.exe"><img alt="Download LakeDB installer for Windows x64" src="https://img.shields.io/badge/Windows-DOWNLOAD_SETUP-0b7cff?style=for-the-badge&logo=windows&logoColor=white"></a>
  <a href="https://github.com/DavLagoHern/LakeDB/releases/download/v1.0.0-beta.6.1/LakeDB-1.0.0-beta.6.1-linux-x86_64.AppImage"><img alt="Download LakeDB AppImage for Linux x64" src="https://img.shields.io/badge/Linux-DOWNLOAD_APPIMAGE-12d9ff?style=for-the-badge&logo=linux&logoColor=020817"></a>
</p>

| Platform | Alternative package | Install |
| --- | --- | --- |
| macOS Apple Silicon | [ZIP](https://github.com/DavLagoHern/LakeDB/releases/download/v1.0.0-beta.6.1/LakeDB-1.0.0-beta.6.1-mac-arm64.zip) | Move `LakeDB.app` to Applications. |
| Windows x64 | [Portable EXE](https://github.com/DavLagoHern/LakeDB/releases/download/v1.0.0-beta.6.1/LakeDB-1.0.0-beta.6.1-win-x64-portable.exe) | Run without installation. |
| Linux x64 | [Debian package](https://github.com/DavLagoHern/LakeDB/releases/download/v1.0.0-beta.6.1/LakeDB-1.0.0-beta.6.1-linux-amd64.deb) | Install with your package manager. |
...
> [Beta 6.1 release page](https://github.com/DavLagoHern/LakeDB/releases/tag/v1.0.0-beta.6.1).

---

## Latest release

LakeDB is currently available as **Beta 6.1**. See its changes and the full
